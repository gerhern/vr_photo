...
<footer class="bg-[#03045E] text-white py-12 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-bold mb-4">ImageManager</h3>
                <p class="text-gray-300">Gestión inteligente de imágenes para todos.</p>
            </div>
            <div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
            <p>&copy; {{ date('Y') }} ImageManager. Todos los derechos reservados.</p>
        </div>
    </div>
</footer>
@endsection
